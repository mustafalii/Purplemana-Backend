# REFERENCE: https://www.youtube.com/watch?v=c96w1JS28AY
import cv2
import numpy as np
import operator
...
def detect():
    ...
    imgTestingNumbers = cv2.imread("slotPicture.png")  # read in testing numbers image
...
#     print("Detecting slot letter")
#     path = "../Web Dev/public/images/scannedCards"
